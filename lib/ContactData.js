...
var ContactData = function () {
    ...
    ContactData.prototype.getPenetration = function getPenetration(body) {
        return body === this.body1 ? this.projection : _Vector2.default.create(this.penetration.x * -1, this.penetration.y * -1);
    };
